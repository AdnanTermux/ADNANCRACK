...
<div class="wrap">
  <section class="hero">
    <div class="hero-copy">
      ...
      <p>Use the public endpoints for open dashboards, temp-number style landing pages, and live widgets. Keep token-protected endpoints on your server for production integrations. The examples below match the current live payloads, including <code>last_hour_otps</code> and <code>generated_at</code>.</p>
    ...
    <div class="hero-side">
      <div class="mini">
        ...
        <strong>/api/public/otps and /api/public/stats</strong>
      </div>
      <div class="mini">
      ...
      <div class="mini">
        ...
        <strong>service, country, otp, message, received_at, last_hour_otps, generated_at</strong>
      </div>
    </div>
  </section>
